/**
 * User Directory Page Controller
 * Main entry point for the class roster page
 * Displays paginated list of students and staff with filtering
 */

import { renderUserDirectory } from "./directoryView.js";
...
/**
 * Initialize the user directory page
...
async function initDirectory() {
  ...
  try {
    ...
    await renderUserDirectory(courseUuid, container);
